...
class DevAPi:
    ...
    def create_dev(self, name, sys_type_name, department_id, ip=1, services=None):
        ...
        services = services if services else self.DEV_TYPE_MAP[sys_type_name]['services']
    ...
    def read_dev(self, name, type_name, department_id, ip=1):
        path = '/api/dev'
        data = {
            'nameContains': name,
            'ipContains': ip,
